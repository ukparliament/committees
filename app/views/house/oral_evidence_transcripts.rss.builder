xml.rss( :version => '2.0', 'xmlns:atom' => 'http://www.w3.org/2005/Atom' ) do
	xml.channel do
		xml.title( "Oral evidence transcripts for the #{@house.label}" )
		xml.description( "Updates whenever a new transcript is published." )
		xml.link( house_oral_evidence_transcripts_url )
		...
		xml.pubDate( @oral_evidence_transcripts.first.published_on.rfc822 )
		xml.tag!( 'atom:link', { :href => house_oral_evidence_transcripts_url( :format => 'rss' ), :rel => 'self', :type => 'application/rss+xml' } )
