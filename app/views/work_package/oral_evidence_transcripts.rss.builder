xml.rss( :version => '2.0', 'xmlns:atom' => 'http://www.w3.org/2005/Atom' ) do
	xml.channel do
		...
		xml.pubDate( @work_package.oral_evidence_transcripts.first.published_on.rfc822 )
		xml.tag!( 'atom:link', { :href => work_package_oral_evidence_transcript_list_url( :format => 'rss' ), :rel => 'self', :type => 'application/rss+xml' } )
		xml << render( :partial => 'oral_evidence_transcript/oral_evidence_transcript', :collection => @work_package.oral_evidence_transcripts )
	end
end